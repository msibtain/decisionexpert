...
<table class="pad2" width="100%" style="border-top:1px solid #969696; border-left:1px solid #969696;" align="center">
        	<tr class="heading_chart">
                ...
                <?php	 	 } ?>
                <td style="<?=$tdStyle?> background:#dddddd;" align="center" width="<?=$tdWidth?>">&nbsp;</td>
        	</tr>
            <?php	 	
			$lr = 0;
			$iterate = 0;
            ...
            <tr class="heading_chart">
                ...
                <?php	 	 } ?>
                <td style="<?=$tdStyle?> background:#dddddd; color:#000;" align="center" width="<?=$tdWidth?>"><strong>Consistency</strong></td>
        	</tr>
        </table>
