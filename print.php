...
<div id="container" class="equal">
	...
	<tr>
        ...
        <h1>Print Project</h1>
        <p>&nbsp;</p>
        <p>AutoDM allows you print six different reports. You may select to print any combination of these reports, <br />or print all of them at once.</p>
        
        <form action="print.post.php?id=<?=$id?>&for_pdf=1" method="post">
        <table width="400" class="pad2" border="1">
            ...
            <tr>
                ...
                <td valign="bottom" width="150"><input type="checkbox" checked="checked" name="option[]" class="options" value="definitions" /> Definitions</td>
            </tr>
            <tr>
              	<td valign="bottom" width="25">&nbsp;</td>
                <td valign="bottom" width="150"><input type="checkbox" checked="checked" name="p_options[]" value="print_all" onclick="javascript: toggleOptions(this.checked);" /> Print all</td>
                <td width="25" valign="bottom">&nbsp;</td>
                <td valign="bottom" width="150"><input type="checkbox" checked="checked" name="option[]" class="options" value="print_cover_sheet" /> Print cover sheet</td>
            </tr>
            <tr>
              <td colspan="4" valign="bottom" align="right"><input type="submit" name="sbt" value="Generate PDF and Print" /></td>
              </tr>
            </table>
        </form>
