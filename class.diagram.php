...
// $Id: Version 0.0.1$
  ...
  class Diagram
  {
    ...
    function Draw($file = "")
    {
	  ...
	  # Sib added;
	  # This is Objective rectangle;
	  $color_Yellow = imagecolorallocate($this->im, 255, 255, 153);
      $this->__Rectangle($x1, $y1, $x2, $y2, $this->im_rect_bordercolor, $color_Yellow);
      imagestring($this->im, $this->font, $x1 + $this->inpadding, $y1 + $this->inpadding, $arrk[0], $this->im_fontcolor);
	  //imagettftext($this->im, 10, 0, $x1 + $this->inpadding, $y1 + $this->inpadding, $this->im_fontcolor, $arial, $arrk[0]);
      $x1 = $x1 + round(($x2 - $x1) / 2);
