...
<table class="pad2" width="100%" style="border-top:1px solid #969696; border-left:1px solid #969696;" align="center">
			...
			foreach ($criterias as $key => $value)
			{
				...
				if (!count($sub_criterias[$key]))
				{
					...
					{
						?>
						<td style="<?=$tdStyle?> background:#e7f6ef; color:#000;" align="center"><?php	 	 
							...
							# Third matrix value;
							echo $o = number_format(($tmp * $criteria_vector_value), 3);
				...
				else
				{
					foreach ($sub_criterias[$key] as $k => $v)
					{
                        ...
                        <tr>
                            ...
                            <td style="<?=$tdStyle?> background:#dddddd; color:#c00000;" align="center">
                           
                            <strong><?=$number_to_show?></strong></td>
                        <?php	 	
						$temp_max = 0;
						$temp_no_to_show = array();
						foreach ($alternatives as $altKey => $altValue)
            ...
            <tr class="heading_chart">
				...
				foreach ($alternatives as $altKey => $altValue) 
				{
					...
					?>
                	<td style="<?=$tdStyle?> background:#dddddd;  color:#000099;" align="center" width="<?=$tdWidth?>"><strong>
					<?php	 	 
					//echo $number_to_show;
					
					echo $overall_result[$altKey];
